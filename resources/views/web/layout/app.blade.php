    ...
    <nav class="navbar navbar-expand-md bg-light">
        <div class="container-fluid">
            ...
            <a class="navbar-brand position-absolute top-50 start-50 translate-middle d-md-block d-none" href="#">
                <img src="{{ asset('web/img/z-logo.svg') }}" alt="Logo" class="img-brand" height="30">
            </a>
            ...
            <div class="offcanvas offcanvas-start w-100" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-header position-relative">
                    ...
                    <button type="button" class="btn-close position-absolute start-0 ms-2 text-primary"
                        ...
                        <div class="navbar-nav w-100">
                            <ul class="navbar-nav w-100">
                                ...
                                <li class="nav-item dropdown dropdown-mega position-static">
                                    <a class="nav-link text-black px-md-3" href="#" role="button"
                                        data-bs-toggle="dropdown" aria-expanded="false">Rent</a>
                                    <div class="dropdown-menu shadow w-100   pb-md-0 pb-5 mb-md-0 mb-5"
                                        id="mega-content">
                                                ...
                                                <div class="row my-md-3">
                                                    ...
                                                    <div class="col-md-2 border-end">
                                                        ...
                                                        <ul class="navbar-nav flex-column">
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link  text-primary"
                                                                    href="#"><small>Messages</small></a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link  text-primary"
                                                                    href="#"><small>Contacted
                                                                        Rentals</small></a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link  text-primary"
                                                                    href="#"><small>Applications</small></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-2 border-end">
                            ...
                            <div class="col-6 col-sm-4 col-md-3">
                                <ul class="list-unstyled">
                                    <li class="my-5 "><img class="rounded-circle border" width="20"
                                            src="{{ asset('web/img/languages/Gb@3x.png') }}" alt=""> English
                                        (UK)</li>
                                    <li class="my-5 "><img class="rounded-circle border" width="20"
